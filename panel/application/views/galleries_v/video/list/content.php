<div class="row">
    <div class="col-md-12">
        <h4 class="m-b-lg">
            <?php echo "Videos of <b>$gallery->title</b> record" ; ?>
            <a href="<?php echo base_url("galleries/new_gallery_video_form/$gallery->id"); ?>" class="btn btn-outline btn-primary btn-xs pull-right"> <i class="fa fa-plus"></i> Add New</a>
        </h4>
    </div><!-- END column -->
    <div class="col-md-12">
                            ...
                            <tr id="ord-<?php echo $item->id; ?>">
                                ...
                                <td class="text-center w200">
                                    ...
                                    <?php if(isAllowedUpdateModule()) { ?>
                                     <a href="<?php echo base_url("galleries/update_gallery_video_form/$item->id"); ?>" class="btn btn-sm btn-info btn-outline"><i class="fa fa-pencil-square-o"></i> Update</a>
                                    <?php } ?>
                                </td>
                            </tr>
