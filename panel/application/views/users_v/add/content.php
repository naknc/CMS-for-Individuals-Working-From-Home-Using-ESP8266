            ...
            <div class="widget-body">
                <form action="<?php echo base_url("users/save"); ?>" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" placeholder="Name and Surname" name="full_name" value="<?php echo isset($form_error) ? set_value("full_name") : ""; ?>">
                        <?php if(isset($form_error)){ ?>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="email" placeholder="E-mail Address" name="email" value="<?php echo isset($form_error) ? set_value("email") : ""; ?>">
                        <?php if(isset($form_error)){ ?>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="password" placeholder="Password Again" name="re_password">
                        <?php if(isset($form_error)){ ?>
