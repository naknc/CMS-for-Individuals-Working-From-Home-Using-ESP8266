    ...
    <div class="col-md-12">
        <h4 class="m-b-lg">
            ...
            <?php if(isAllowedWriteModule()) { ?>
                <a href="<?php echo base_url("brands/new_form"); ?>" class="btn btn-outline btn-primary btn-xs pull-right"> <i class="fa fa-plus"></i> Add New</a>
            <?php } ?>
        </h4>
    </div><!-- END column -->
    <div class="col-md-12">
                            ...
                            <tr id="ord-<?php echo $item->id; ?>">
                                ...
                                <td class="text-center w200">
                                    ...
                                    <?php if(isAllowedUpdateModule()) { ?>
                                        <a href="<?php echo base_url("brands/update_form/$item->id"); ?>" class="btn btn-sm btn-info btn-outline"><i class="fa fa-pencil-square-o"></i> Update</a>
                                    <?php } ?>
                                </td>
                            </tr>
